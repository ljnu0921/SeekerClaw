...
- **App update (Store / `adb install -r`):** memory files (SOUL.md, MEMORY.md, IDENTITY.md, USER.md, daily notes, cron jobs, skills) preserved verbatim — no impact on prior conversations, agent personality, or scheduled tasks.
